...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/glen/Documents/TUGAS DEL/PABWE/Tugas Praktikum/latihan-laravel/latihan-laravel/public/storage' => 'string',
...
'filesystems.disks.s3.report','filesystems.links./home/glen/Documents/TUGAS DEL/PABWE/Tugas Praktikum/latihan-laravel/latihan-laravel/public/storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'signed','throttle','verified','check.auth',);
        registerArgumentsSet('routes', 
'livewire.update','livewire.upload-file','livewire.preview-file','auth.login','auth.register','auth.logout','app.home','storage.local',);
        registerArgumentsSet('views', 
'layouts.app','layouts.auth','livewire.auth-login-livewire','livewire.auth-register-livewire','livewire.home-livewire',
'pages.app.home','pages.auth.login','pages.auth.register','welcome','laravel-exceptions-renderer::components.badge',
...
'validation.custom.addUserId.required','validation.custom.addPaket.required','validation.custom.addPaket.array','validation.custom.addTanggalExpired.required','validation.custom.addTanggalExpired.date',
'validation.custom.addLimits.required','validation.attributes.addUserId','validation.attributes.addPaket','validation.attributes.addTanggalExpired','validation.attributes.addLimits',
'validation.attributes.email','validation.attributes.password','validation.attributes.name','validation.attributes.username','validation.attributes.address',
'validation.attributes.phone','validation.attributes.city','validation.attributes.province',);
